...
public class Salary 
{
    ...
    int cpf;
    int netSalary;
    public Salary(int basicSalary, int hra, int conveyenceAllowance,int otherAllowance, int personalAllowance, int monthlyTax, int epf,int cpf, int netSalary) 
    {
        super();
